...
import { PlusCircle, Loader2, LayoutGrid, List, Image as ImageIcon, Circle, MapPin, Edit, Trash2 } from "lucide-react"
...
export default function Vehicles() {
  const { vehicles, vehiclesMeta, fetchVehicles, isLoading, createVehicle, deleteVehicle } = useStore()
        ...
        <AlertDialogContent className="bg-slate-900 border-slate-800 text-slate-50">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-slate-400">
              ...
              <span className="font-bold text-slate-200 mx-1">{vehicleToDelete}</span>
              and remove it from the system.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
          <AlertDialogCancel onClick={() => setVehicleToDelete(null)} className="bg-transparent border-slate-700 hover:bg-slate-800 text-slate-300">Cancel</AlertDialogCancel>
          <Button 
